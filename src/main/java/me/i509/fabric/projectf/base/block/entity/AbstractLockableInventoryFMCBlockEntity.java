...
public abstract class AbstractLockableInventoryFMCBlockEntity<I extends SerializableInventory> extends AbstractInventoryFMCBlockEntity<I> implements LockableBlockEntity, Nameable {
	protected ContainerLock lock;
	protected Text customName;

	protected AbstractLockableInventoryFMCBlockEntity(BlockEntityType<? extends AbstractLockableInventoryFMCBlockEntity> type, I inventory, long capacity) {
		super(type, inventory, capacity);
