...
public class FMCArmorFeatureRenderer<T extends LivingEntity, M extends BipedEntityModel<T>, A extends BipedEntityModel<T>> extends FeatureRenderer<T, M> {
	public FMCArmorFeatureRenderer(FeatureRendererContext<T, M> context) {
		super(context);
	}
